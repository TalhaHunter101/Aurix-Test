...
1. Keyword Spam: Is there intentional keyword stuffing or repeated keywords that don't relate to the content?
2. Malicious Links: Are there deceptive, phishing, or suspicious links trying to steal information?
3. Advertisements: Is this promotional content encouraging readers to buy products/services?
4. Wrong Language: Is this content primarily in a language other than English?
5. Unreadable: Is this content corrupted, empty, or incomprehensible?
    ...
    def analyze_content(self, content: str, uid: str, max_retries: int = 3) -> Dict[str, Any]:
        ...
        for attempt in range(max_retries):
            try:
                ...
                for key in ['keyword_spam', 'malicious_links', 'ads', 'wrong_language', 'unreadable']:
    ...
    def process_batch(self, data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for item in data:
            ...
            try:
                ...
                # Add default result for failed items
                results.append({
                    "uid": item['uid'],
